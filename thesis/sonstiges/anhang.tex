\chapter{Systemkonfiguration und Variablen-Mapping}
\label{ch:AA_configuration_and_variable_mapping}
...
\begin{longtable}{@{} >{\raggedright\arraybackslash}p{0.32\textwidth} p{0.10\textwidth}
    ...
    Frame-Latenz (Delta Time), gemessen über \ac{CPU}-Timer. \\
...
\chapter{Struktur des digitalen Anhangs}
\label{ch:AB_digital_appendix}

\dirtree{%
    .1 MarBau-201521192\_BA\_Digitaler\_Anhang.
    .2 Generative\_KI\DTcomment{Sämtliche Prompts \& Antworten}.
