...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{@{} l X @{}}  % <-- Geändert auf tabularx und \textwidth
        ...
        \midrule
        Prozessor (CPU)                   & Intel Core i5-6600K @ 3.50\,GHz (4 logische Kerne) \\
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{} l l l >{\raggedright\arraybackslash}X @{}}
        ...
        \texttt{currentLodIndex}     & 0 bis 4               & 5.1.1               & Skaliert den geometrischen
        Detailgrad pro Objekt.\\
        \texttt{activeObstacleCount} & bis 50.000            & 5.1.2, 5.1.3, 5.3.3 & Anzahl der gerenderten Instanzen.
        Forciert CPU-Overhead oder Z-Achsen-Overdraw-Dichte.\\
        \texttt{renderResolution}    & 480p bis 4K           & 5.2.1               & Absolute Render-Auflösung zur
        Messung der Fill-Rate. \\
        \texttt{renderFloor}         & \textit{Boolean}      & 5.2.2               & Erzeugt eine Basis-Bandbreitenlast
        (Max Fill-Rate) durch eine raumfüllende Geometrie.\\
        \texttt{activeLightCount}    & 10 bis 5.000          & 5.3.1, 5.3.2.2      & Anzahl der aktiven dynamischen
        Lichter im Frustum.\\
        \texttt{lightIntensity}      & 0,5 bis 20,0          & 5.3.2.1             & Multiplikator für den Lichtradius.
        Forciert RMW-Speicher-Sättigung.\\
        \texttt{useClusteredStyles}  & \textit{Boolean}      & 5.4.1               & Steuert die stilistische Entropie.
        Schaltet zwischen geklusterter und gestreuter Verteilung um.\\
        \texttt{enableGooch/Toon}    & 1 bis 3 Stile         & 5.4.2               & Stil-Kombinatorik.
        Skaliert die Anzahl der gleichzeitig in einem Frame evaluierten Shading-Modelle.\\
        \texttt{kuwaharaRadius}      & 2 bis 16              & 5.4.3               & Filtergröße für den
        Kuwahara-Kernel.
        Dient der Sättigung der Textur-Bandbreite.\\
        Feature Accumulation         & Pass 1 bis 4          & 5.5.x               & Kumulative Aktivierung von Geometrie, Basis-Shading und hoher Stil-Entropie über einen determinierten Kamerapfad. \\
        \bottomrule
    \end{tabularx}
\end{table}
...
und zur späteren statistischen Auswertung in das
CSV-Export-Modul exportiert.
Tabelle~\ref{tab:dependent_vars} kategorisiert die extrahierten Leistungs- und Szenenmetriken.
...
% Einleitungstext zu den Kontrollvariablen
Den Abschluss des Variablen-Mappings bilden die Kontrollvariablen.
Diese Systemparameter definieren die statische Baseline des Frameworks.
Um statistischen Schwankungen zu vermeiden und eine reproduzierbare Ausgangslage für alle Messreihen zu garantieren,
werden diese Werte strikt eingefroren, sofern die jeweilige Test-Suite sie nicht explizit als unabhängige Variable
überschreibt.
Tabelle~\ref{tab:controlled_vars} fasst die Standardkonfiguration der Orchestrierungs-, Rendering- und Physik-Module
zusammen.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{} l l >{\raggedright\arraybackslash}X @{}}
        ...
        \midrule
        Test-Orchestrierung     & \texttt{warmupDuration}            & 10,0~Sekunden (zur Sättigung der Caches)                \\
