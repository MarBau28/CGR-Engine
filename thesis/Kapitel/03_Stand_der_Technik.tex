...
Durch die Betrachtung bestehender Verfahren im Kontext des NPR werden deren konzeptionelle und leistungstechnische
...
Abschnitt~\ref{sec:grundlagen_forward} dargelegt, im multiplikativen Aufwand von $\mathcal{O}(G \cdot L)$ bei hoher
...
dient~\parencite[vgl.][Folie \textit{Visibility Buffer}]{Karis_Nanite_SIGGRAPH_Advances_2021_final}.
...
% NPR
Hinsichtlich des NPR unterscheidet die aktuelle Literatur primär zwischen
\textit{Object-Space}- und
\textit{Screen-Space}-Methoden~\parencite[vgl.][S. 148]{magdicsPostprocessingNPREffects2013}.
...
Schnittmenge mit selektivem NPR in Deferred-Pipelines jedoch theoretischen Limitierungen
unterliegt.
...
der für NPR (NPR) zwingend erforderlichen Heterogenität individueller Stilisierungen zwingt die
...
unweigerlich zu einem sogenannten \textit{Fat G-Buffer}~\parencite[vgl.][S. 71]{AdvancesRealTimeRendering}.
...
insbesondere im Kontext der selektiven Stilisierung beim NPR.
...
diese Engpässe spezifisch im Kontext des NPR quantifiziert.
