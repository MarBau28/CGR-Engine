...
Ein primärer Lösungsansatz hierfür ist das \textit{\ac{G-Buffer} Packing} in Kombination mit \enquote{Shading-Model-IDs}.
Um die Speicherbandbreite zu limitieren, werden ungenutzte Datenkanäle klassischer Physically-Based-Rendering-Pipelines
(\ac{PBR}) wiederverwendet oder redefiniert.
...
Um die strukturellen Limitierungen des \ac{G-Buffer}s hinsichtlich Materialvielfalt zu adressieren, implementieren moderne
...
verfahren wie \textit{Stencil-Masking} zurück~\cite[S.~81]{AdvancesRealTimeRendering}.
...
verglichen: naives Forward Rendering, klassisches Deferred Shading mit \ac{G-Buffer}-Packing (mittels Style-IDs und
Uber-Shader) sowie Deferred Light Volumes als Referenz für Multi-Pass-Architekturen.
