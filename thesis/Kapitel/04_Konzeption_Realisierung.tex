...
if (useBlinnFallback) {
    ...
    \end{minted}
    \caption{GLSL-Pseudocode des Deferred-Uber Lighting-Passes im HyDra-Framework}
...
% Linkes Bild
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Abbildungen/hydra_capture_20260712_123807}
...
% Rechtes Bild
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Abbildungen/hydra_capture_20260712_123817}
        \caption{Post-Lit Kuwahara in Deferred-Volume}
        \label{fig:hydra_post-lit}
    \end{subfigure}
    \caption{Visueller Vergleich von Pre-Lit und Post-Lit Verfahren in HyDra mittels Kuwahara-Filter.}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Abbildungen/hydra_capture_20260430_153519}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Abbildungen/hydra_capture_20260430_153528}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Abbildungen/hydra_capture_20260430_151409}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Abbildungen/hydra_capture_20260430_151418}
...
% Post-Lit Vorteil
Im Gegensatz zur Deferred-Uber-Architektur bietet die Deferred-Volume-Architektur den Vorteil, dass Bildraumeffekte ohne
den Zwang, Pre-Lit-Verfahren anzuwenden, mit Post-Lit-Verfahren erzielt werden können
...
(simultanes Abfragen von G-Buffer-Identitätsdaten und dem akkumulierten Lichtpuffer).


%\begin{figure}[htbp]
%    \centering
%    \includegraphics[width=\textwidth]{Abbildungen/hydra_capture_20260524_103923}
%    \caption{Artefaktbildung durch fixed-radius Bildraumfilterung in der Tiefendistanz.}
