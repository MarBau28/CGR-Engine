...
Abschnitt~\ref{subsec:020101_forward_rendering} dargelegt, im multiplikativen Aufwand von
...
Rendering-Paradigmen: naives Forward Rendering, simples Deferred Shading mit \ac{G-Buffer}-Packing über
Style-IDs und Uber-Shader sowie Deferred Light-Volumes als Referenz für Multi-Pass-Architekturen.
Ziel ist die Erarbeitung einer empirischen Basis für ein fundiertes Entscheidungsmodell.
...
Das im Rahmen der vorliegenden Arbeit entwickelte Evaluations-Framework \ac{HyDra}
(siehe Abbildung~\ref{fig:hydra_example}) dient der methodischen Umsetzung dieses Vorhabens.
Durch die Erhebung granularer Rohdaten unter skalierender Stil-Entropie und Szenenkomplexität soll ein heuristisches
Entscheidungsmodell abgeleitet werden.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\linewidth]{abbildungen/hydra_capture_20260717_200713}
    \caption{Screenshot aus HyDra-Framework.}
