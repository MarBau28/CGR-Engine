...
dieses Ansatzes zunehmend relativiert~\parencite[vgl.][]{olssonClusteredDeferredForward2012, haradaForwardBringingDeferred2012}.
...
zwangsweise eine gewisse Menge an Overdraw zu erzeugen~\parencite[vgl.][S.~1]{fatahalianReducingShadingGPUs2010}.
Ansätze wie ein Z-Prepass zur frühzeitigen Verwerfung verdeckter Fragmente gehören in Forward-Pipelines zwar zum
Standard~\parencite[vgl.][S.~57]{burnsVisibilityBufferCacheFriendly2013}, reichen bei hoher Objekt- und Lichtkomplexität
...
Beleuchtungsszenarien weitestgehend durchgesetzt~\parencite[vgl.][Abschn.~2]{mallettDeferredAdaptiveCompute2018}, weisen jedoch
...
\ac{V-Buffer}~\parencite[vgl.][]{burnsVisibilityBufferCacheFriendly2013}, welcher als Shading-Grundlage für hochkomplexe
...
\ac{MSAA} glättet Objektkanten bereits während des geometrischen Rasterisierungsschritts
(vgl.\ Kap.~\ref{subsec:020102_rendering_pipeline}).
...
verrechnen~\parencites(vgl.)()[S.~5]{Thaler2011DeferredRendering}[]{taaantialiasing}.
...
transluzente Objekte gelöst~\parencite[vgl.][S.~56]{burnsVisibilityBufferCacheFriendly2013}.
...
führen~\parencite[vgl.][Abschn.~2.6]{Thaler2011DeferredRendering}.
...
architektonischer Engpässe fokussiert ist~\parencite[vgl.][S.~56]{burnsVisibilityBufferCacheFriendly2013}.
...
unweigerlich zu einem sogenannten \textit{Fat \ac{G-Buffer}}~\parencite[vgl.][S.~71]{AdvancesRealTimeRendering}.
...
Shader-Strukturen (Uber-Shadern)~\parencite[vgl.][Folie~\enquote{Problems}]{deferredLightinginUncharted4}.
...
objektbasierte Zuweisung zu gewährleisten~\parencite[vgl.][S.~81]{AdvancesRealTimeRendering}.
...
gekoppelt~\parencite[vgl.][Folie~\enquote{\ac{G-Buffer}: Our approach}]{valientDeferredRenderingKillzone}.
...
\begin{figure}[H]
    ...
    \vspace{0.25cm} % Optionaler vertikaler Abstand zwischen den Teilabbildungen
    ...
    \caption[Visualisierung von Pipeline-Fragmentierung in \textit{PRAGMATA}]{Visualisierung von Pipeline-Fragmentierung
    am Beispiel von \textit{PRAGMATA} (2026) zur Veranschaulichung spezialisierter
    Industrie-Workarounds (Quelle: \parencite{muhammadPrettyFramesPRAGMATA2026}).}
...
dokumentiert~\parencites(vgl.)()[S.~881]{akenine-mollerRealtimeRendering2019}[Abschn.~2.6]{Thaler2011DeferredRendering}
