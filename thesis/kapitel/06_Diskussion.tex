...
(vgl.\ ~Kapitel~\ref{subsec:020303_warp_divergence_and_register_pressure}) für die Deferred-Uber-Pipeline in
...
(vgl.\ Kapitel~\ref{subsec:020302_memory_bandwidth}).
...
\begin{description}
    ...
    (vgl.\ ~\ref{subsec:020201_forward_rendering} u.~\ref{subsec:020202_deferred_rendering}).
    ...
    Shader-Strukturen durch vereinheitlichte Shading-Pässe aufweisen (vgl.\ ~\ref{subsec:020202_deferred_rendering}).
    ...
    signifikanter Performance-Engpass herausstellen (vgl.\ ~\ref{subsec:020302_memory_bandwidth}).
