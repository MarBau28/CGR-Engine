...
\begin{description}
    ...
    Speicherbelastungen aufweist und damit eine höhere Grundlast auf der \ac{GPU} verursacht, um Artefaktbildungen zu
    vermeiden (vgl.\ ~\ref{subsec:040203_deferred_volume_pipeline}).
...
festgestellt werden.
Im Rahmen der Analyse spezifischer, in hohem Maße hardwareinterner Phänomene und Flaschenhälse erweisen sich empirische
Vorgehensweisen, die sich ausschließlich auf die Messung von Verarbeitungszeiten konzentrieren, häufig als unzureichend,
um ein umfassendes Bild der Ursachen und Limitierungen der betreffenden Phänomene und Hardware-Kipppunkte zu gewinnen.
