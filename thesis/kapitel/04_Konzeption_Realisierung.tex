...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=0.85\linewidth]{abbildungen/IMG-20260711205352333}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=0.85\linewidth]{abbildungen/IMG-20260711205459842}
...
Für die Evaluation der zugrunde liegenden Stilisierungseffekte werden im \ac{HyDra}-Framework neben einer Baseline
(Blinn-Phong-Schattierung) verschiedene \ac{NPR}-Effekte implementiert.
...
\ac{NPR}-Effekte und das Baseline-Shading die jeweils verbreiteten Standardlösungen implementiert wurden.
...
\begin{longtable}{@{} p{3.5cm} p{6.0cm} p{6.0cm} @{}}
    ...
    \textbf{Kuwahara}\newline \cite{kyprianidisImageVideoAbstraction2009}
    \newline (siehe Abb.~\ref{fig:040202_pre-post-lit_comparison}) &
    ...
    \newline (siehe Abb.~\ref{fig:040201_outline_comparison}) &
    ...
    klassischer Cel-Animationen. \\
    \addlinespace

    \textbf{Gooch}\newline \cite{goochNonphotorealisticLightingModel1998}
    \newline (siehe Abb.~\ref{fig:gooch_example}) &
    Lineare Interpolation zwischen definierten Cool- und Warm-Colors basierend auf dem Skalarprodukt ($N \cdot L$).
    & Verbessert die visuelle Wahrnehmung von Geometriedetails durch Temperaturkontraste; Vorrangig verwendet für für
    technische Illustrationen. \\
    \addlinespace

    \textbf{Sobel}\newline \cite[Kap.~3.3]{saitoComprehensibleRendering3D1990}
    \newline (siehe Abb.~\ref{fig:hydra_solebl-outlines}) &
    ...
    \newline (siehe Abb.~\ref{fig:hydra_inverted-hull}) &
