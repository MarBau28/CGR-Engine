...
Die stilisierte Darstellung komplexer 3D-Szenen und einzelner Objekte darin mittels \ac{NPR} ist in der modernen Computergrafik sowohl für technische als auch für unterhaltende Anwendungen von großer
Bedeutung.
...
Insbesondere die individuelle Praxis großer Spieleproduktionen sieht sich mit der Notwendigkeit
...
\begin{figure}[htbp]
    ...
    mittels Cel-Shading am Beispiel von \textit{Borderlands 4}
...
Eine derartige funktionale Hervorhebung durch Simplifizierung ist mit gängigem \ac{PBR} in dieser Form oft
...
Dieses erweist sich wiederum als stark ineffizient bei hoher
...
Rendering-Architekturen im Kontext der selektiven Stilisierung mittels \ac{NPR}, mit einem speziellen Fokus auf das in diesem
...
Die Implementierung und Evaluation komplexer Sondereffekte, wie etwa die Verarbeitung semitransparenter Geometrie
(Transluzenzen) oder \textit{Anti-Aliasing}, sind nicht Teil dieser Untersuchung, da sie den
Rahmen der grundlegenden Analyse der Basis-Rendering-Architekturen sprengen würden.
...
gewährleisten:
Kapitel~\ref{ch:02_grundlagen} vermittelt zunächst die architektonischen und hardwaretechnischen Grundlagen sowie relevante
technische Begrifflichkeiten, die für das Verständnis der weiteren Untersuchungen erforderlich sind.
Kapitel~\ref{ch:03_acedemic_and_industry_state} analysiert im Anschluss den aktuellen Stand der Forschung sowie der Industriepraxis und grenzt darauf
