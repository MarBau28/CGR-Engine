...
Abstraktionen (siehe Abb.~\ref{fig:borderlands_npr_example}).
...
Im Kontext dieser Arbeit beschreibt der Begriff hybrider Pipelines die koexistierende Anwendung unterschiedlicher
\ac{NPR}-Stile innerhalb desselben Frames im Sinne einer selektiven Stilisierung.
...
Gemäß den Vorgaben des §14a der Rahmenprüfungsordnung sind die vollständigen, inhaltlich relevanten Chat-Verläufe,
